...
public static unsafe partial class Gdiplus
{
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipLoadImageFromFile([NativeTypeName("const WCHAR *")] char* filename, [NativeTypeName("Gdiplus::GpImage **")] GpImage** image);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipLoadImageFromFileICM([NativeTypeName("const WCHAR *")] char* filename, [NativeTypeName("Gdiplus::GpImage **")] GpImage** image);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipSaveImageToFile([NativeTypeName("Gdiplus::GpImage *")] GpImage* image, [NativeTypeName("const WCHAR *")] char* filename, [NativeTypeName("const CLSID *")] Guid* clsidEncoder, [NativeTypeName("const Gdiplus::EncoderParameters *")] EncoderParameters* encoderParams);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateBitmapFromFile([NativeTypeName("const WCHAR *")] char* filename, [NativeTypeName("Gdiplus::GpBitmap **")] GpBitmap** bitmap);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateBitmapFromFileICM([NativeTypeName("const WCHAR *")] char* filename, [NativeTypeName("Gdiplus::GpBitmap **")] GpBitmap** bitmap);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateBitmapFromResource(HINSTANCE hInstance, [NativeTypeName("const WCHAR *")] char* lpBitmapName, [NativeTypeName("Gdiplus::GpBitmap **")] GpBitmap** bitmap);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateMetafileFromFile([NativeTypeName("const WCHAR *")] char* file, [NativeTypeName("Gdiplus::GpMetafile **")] GpMetafile** metafile);

    /// <include file='Gdiplus.xml' path='doc/member[@name="Gdiplus.GdipCreateMetafileFromWmfFile"]/*' />
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateMetafileFromWmfFile([NativeTypeName("const WCHAR *")] char* file, [NativeTypeName("const Gdiplus::WmfPlaceableFileHeader *")] WmfPlaceableFileHeader* wmfPlaceableFileHeader, [NativeTypeName("Gdiplus::GpMetafile **")] GpMetafile** metafile);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipCreateFontFamilyFromName([NativeTypeName("const WCHAR *")] char* name, [NativeTypeName("Gdiplus::GpFontCollection *")] GpFontCollection* fontCollection, [NativeTypeName("Gdiplus::GpFontFamily **")] GpFontFamily** fontFamily);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipGetFamilyName([NativeTypeName("const Gdiplus::GpFontFamily *")] GpFontFamily* family, [NativeTypeName("LPWSTR")] char* name, [NativeTypeName("LANGID")] ushort language);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipDrawString([NativeTypeName("Gdiplus::GpGraphics *")] GpGraphics* graphics, [NativeTypeName("const WCHAR *")] char* @string, int length, [NativeTypeName("const Gdiplus::GpFont *")] GpFont* font, [NativeTypeName("const Gdiplus::RectF *")] GpRectF* layoutRect, [NativeTypeName("const Gdiplus::GpStringFormat *")] GpStringFormat* stringFormat, [NativeTypeName("const Gdiplus::GpBrush *")] GpBrush* brush);
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::GpStatus")]
    public static extern GpStatus GdipMeasureCharacterRanges([NativeTypeName("Gdiplus::GpGraphics *")] GpGraphics* graphics, [NativeTypeName("const WCHAR *")] char* @string, int length, [NativeTypeName("const Gdiplus::GpFont *")] GpFont* font, [NativeTypeName("const Gdiplus::RectF &")] GpRectF* layoutRect, [NativeTypeName("const Gdiplus::GpStringFormat *")] GpStringFormat* stringFormat, int regionCount, [NativeTypeName("Gdiplus::GpRegion **")] GpRegion** regions);
