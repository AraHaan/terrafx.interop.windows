...
public unsafe partial struct GpRectF
{
    ...
    public readonly BOOL Equals([NativeTypeName("const Gdiplus::RectF &")] GpRectF* rect)
    {
    ...
    public readonly BOOL Contains([NativeTypeName("const Gdiplus::PointF &")] GpPointF* pt)
    {
        return Contains(pt->X, pt->Y);
    }

    public readonly BOOL Contains([NativeTypeName("const Gdiplus::RectF &")] GpRectF* rect)
    {
    ...
    public readonly BOOL IntersectsWith([NativeTypeName("const Gdiplus::RectF &")] GpRectF* rect)
    {
