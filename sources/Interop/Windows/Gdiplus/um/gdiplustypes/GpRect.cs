...
public unsafe partial struct GpRect
{
    ...
    public readonly BOOL Equals([NativeTypeName("const Gdiplus::Rect &")] GpRect* rect)
    {
    ...
    public readonly BOOL Contains([NativeTypeName("const Gdiplus::Point &")] GpPoint* pt)
    {
    ...
    public readonly BOOL IntersectsWith([NativeTypeName("const Gdiplus::Rect &")] GpRect* rect)
    {
