...
public static unsafe partial class Windows
{
    ...
    [DllImport("url", ExactSpelling = true)]
    public static extern HRESULT TranslateURLW([NativeTypeName("PCWSTR")] char* pcszURL, [NativeTypeName("DWORD")] uint dwInFlags, [NativeTypeName("__unaligned PWSTR *")] char** ppszTranslatedURL);
